                ...
                { //4
                    ...
                    case .currentUser:
                        ...
                        if currentID == AuthProvider.Instance.userID() {
                            ...
                            if let picturesDownloadURL = profile["picturesDownloadURL"] as? NSArray {
                                
                                self.currentProfile?.picturesDownloadURL = picturesDownloadURL as! [String]
                    ...
                    case .notCurrentUser:
                        ...
                        let profileQueried = Profile(name: name as! String,
                                                     age: age as! Int,
                                                     location: location as! String,
                                                     gender: gender as! String,
                        ...
                        if let picturesDownloadURL = profile["picturesDownloadURL"] as? NSArray {
                            ...
                            profileQueried.picturesDownloadURL = picturesDownloadURL as! [String]
                        }
                        ...
                        if let matchedUsers = self.currentProfile?.matchedUsers {
                            ...
                            if matchedUsers.contains(currentID) {
                                addedProfilesCache.append(profileQueried)
                            } else if (allRequestSenders?.contains(currentID))!{
                                requestProfilesCache.append(profileQueried)
